          ...
          {options.map((option) => (
            <TouchableOpacity
              ...
              style={[
                ...
                option.value === selected && [dropStyles.menuItemActive, { backgroundColor: t.accentSubtle }],
              ]}
              onPress={() => {
              ...
              activeOpacity={0.7}
            >
              <Text style={[dropStyles.menuItemText, { color: t.textSecondary }, option.value === selected && [dropStyles.menuItemTextActive, { color: t.accent }]]}>
                {option.label}
              </Text>
            </TouchableOpacity>
          ))}
...
const ActionButton = ({ text, onPress, danger = false }: ActionButtonProps) => (
  <ThemeActionButton text={text} onPress={onPress} danger={danger} />
);

const ThemeActionButton = ({ text, onPress, danger = false }: ActionButtonProps) => {
  const { t } = useTheme();
    ...
    <TouchableOpacity
      style={[
        ...
        danger
          ...
          : [styles.actionButtonDefault, { borderColor: t.accent }],
      ]}
      onPress={onPress}
      activeOpacity={0.7}
    >
    ...
    >
      ...
      <View style={[styles.sectionCard, { backgroundColor: t.surface }]}>
        ...
        <SettingsRow label="Accent color" isLast>
          <TouchableOpacity
            style={[styles.colorPreview, { backgroundColor: t.accent, borderColor: t.accentDark }]}
            ...
            {[0.25, 0.5, 0.75, 1].map((value) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  sfxVolume >= value && [styles.volumeDotActive, { backgroundColor: t.accent }],
                ]}
                onPress={() => {
                  setSfxVolume(value);
        ...
        <SettingsRow label="Disclosure status">
          <View style={[
            ...
            settings.dataDisclosureAccepted
              ...
              : [styles.statusPending, { backgroundColor: t.accentTintSelected }],
          ]}>
            <Text style={[
              styles.statusPillText,
              settings.dataDisclosureAccepted
                ? styles.statusAcceptedText
                : [styles.statusPendingText, { color: t.accent }],
            ]}>

...
const styles = StyleSheet.create({
  ...
  autoButton: { paddingVertical: 16, paddingHorizontal: 16, borderTopLeftRadius: RADIUS.pill, borderBottomLeftRadius: RADIUS.pill, borderWidth: 1.5, borderColor: COLORS.accent, borderRightWidth: 0, backgroundColor: 'transparent', flex: 1 },
  ...
  startButton: {
    ...
    borderTopRightRadius: RADIUS.pill, borderBottomRightRadius: RADIUS.pill, flex: 1, ...SHADOWS.button,
  },
  startButtonText: { fontSize: 16, fontWeight: '800', letterSpacing: 1, fontFamily: Platform.OS === 'ios' ? 'System' : 'sans-serif' },
  runningButton: {
    backgroundColor: COLORS.accent, paddingVertical: 16, paddingHorizontal: 40,
    borderTopRightRadius: RADIUS.pill, borderBottomRightRadius: RADIUS.pill, flex: 1,
